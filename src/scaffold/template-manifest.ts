...
export const TEMPLATE_FILES = [
  ...
  "src/scaffold/templates/.opencode/settings.json.ts",
  "src/scaffold/templates/.opencode/plugins/deno-guards.ts",
  "src/scaffold/templates/.opencode/plugins/code-grade.ts",
